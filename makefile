CC = g++
CFLAGS = -std=c++23 -I include -L lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_ttf
ERRFLAGS = -Wall -Wextra


test : bin\test.exe

bin\test.exe : bin\SDL_Extras.o bin\SDLE_Button.o bin\SDLE_collision.o bin\SDLE_drawing.o bin\SDLE_ScrollBar.o bin\SDLE_ProgressBar.o bin\SDLE_Text.o bin\SDLE_vector.o bin\SDLE_Color.o bin\test.o
...
bin\SDLE_Color.o : src\SDLE_Color.cpp
	$(CC) $(ERRFLAGS) -o $@ -c $< $(CFLAGS)
